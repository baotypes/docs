...
![click here to apply to start a DAO.png](/images/clickheretoapplytostartaDAO.png)
...
- You will need the Collection Address. It's easy to find on Magic Eden if you inspect one of the NFTs in a collection.
